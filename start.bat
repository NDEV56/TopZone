...
if errorlevel 1 (
    ...
    echo  2. Download versi LTS ^(yang ada tulisan "Recommended"^)
    echo  3. Install seperti install aplikasi biasa, klik Next-Next-Finish
    echo  4. Setelah selesai, jalankan lagi file start.bat ini
    echo.
    pause
    exit /b 1
)
